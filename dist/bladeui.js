...
document.addEventListener('alpine:init', function () {
  window.Alpine.store('bladeui:color-picker', colorPicker_1["default"]);
  window.Alpine.store('bladeui:modal', modal_1["default"]);
});
...
exports["default"] = function () {
  ...
  return _objectSpread(_objectSpread(_objectSpread({}, alpine_1.baseComponent), positioning_1.positioning), {}, {
    ...
    get colors() {
      ...
      return (_window$Alpine$store$ = (_window$Alpine$store = window.Alpine.store('bladeui:color-picker')) === null || _window$Alpine$store === void 0 ? void 0 : _window$Alpine$store.colors) !== null && _window$Alpine$store$ !== void 0 ? _window$Alpine$store$ : [];
    },
    init: function init() {
...
exports["default"] = function (options) {
  return {
    ...
    init: function init() {
      this.$nextTick(function () {
        window.BladeUI.dispatchHook("".concat(options.id, ":load"));
      });
    },
    ...
    fillDialogIcon: function fillDialogIcon(icon) {
      ...
      fetch("/bladeui/icons/".concat((_icon$style = icon.style) !== null && _icon$style !== void 0 ? _icon$style : 'outline', "/").concat(icon.name), {
        headers: {
    ...
    createButton: function createButton(options, action) {
      ...
      fetch("/bladeui/button?".concat(params), {
        headers: {
          'Accept': 'application/json'
        }
      }).then(function (response) {
...
document.addEventListener('alpine:init', function () {
  window.Alpine.data('bladeui_dropdown', dropdown_1["default"]);
  window.Alpine.data('bladeui_modal', modal_1["default"]);
  window.Alpine.data('bladeui_dialog', dialog_1["default"]);
  window.Alpine.data('bladeui_notifications', notifications_1["default"]);
  window.Alpine.data('bladeui_inputs_maskable', maskable_1["default"]);
  window.Alpine.data('bladeui_inputs_currency', currency_1["default"]);
  window.Alpine.data('bladeui_inputs_number', number_1["default"]);
  window.Alpine.data('bladeui_inputs_password', password_1["default"]);
  window.Alpine.data('bladeui_select', select_1["default"]);
  window.Alpine.data('bladeui_timepicker', time_picker_1["default"]);
  window.Alpine.data('bladeui_datetime_picker', datetime_picker_1["default"]);
  window.Alpine.data('bladeui_color_picker', color_picker_1["default"]);
});
...
exports["default"] = function (options) {
  return _objectSpread(_objectSpread({}, focusables_1.focusables), {}, {
    ...
    id: (0, uuid_1["default"])(),
    store: window.Alpine.store('bladeui:modal'),
    init: function init() {
      var _this = this;
...
exports["default"] = function () {
  return {
    ...
    init: function init() {
      this.$nextTick(function () {
        window.BladeUI.dispatchHook('notifications:load');
      });
    },
    ...
    fillNotificationIcon: function fillNotificationIcon(notification) {
      ...
      fetch("/bladeui/icons/outline/".concat(notification.icon.name)).then(function (response) {
        return response.text();
      }).then(function (text) {
...
var showDialog = function showDialog(options, componentId) {
  var event = new CustomEvent("bladeui:".concat(makeEventName(options.id)), {
    detail: {
      options: options,
...
var showConfirmDialog = function showConfirmDialog(options, componentId) {
  ...
  var event = new CustomEvent("bladeui:confirm-".concat(makeEventName(options.id)), {
    detail: {
      options: options,
      componentId: componentId
    }
...
var initialize = function initialize(component) {
  ...
  elements.forEach(function (element) {
    ...
    if (insideAlpineComponent) {
      return element.setAttribute('x-on:click', "$bladeui.confirmAction(".concat(confirmData, ", '").concat(componentId, "')"));
    }
...
window.$openModal = function (name) {
  return window.dispatchEvent(new Event("open-bladeui-modal:".concat((0, lodash_kebabcase_1["default"])(name))));
};
...
document.addEventListener('DOMContentLoaded', function () {
  return window.BladeUI.dispatchHook('load');
});
exports["default"] = BladeUI;
...
var notify = function notify(options, componentId) {
  var event = new CustomEvent('bladeui:notification', {
    detail: {
      options: options,
      componentId: componentId
    }
...
var confirmNotification = function confirmNotification(options, componentId) {
  ...
  var event = new CustomEvent('bladeui:confirm-notification', {
    detail: {
      options: options,
      componentId: componentId
    }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkbladeui"] = self["webpackChunkbladeui"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["bladeui"], () => (__webpack_require__("./ts/index.ts")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["bladeui"], () => (__webpack_require__("./resources/css/bladeui.css")))

...
import { baseComponent, Component, Entangle, BladeUIModifiers } from '@/components/alpine'
...
export type InitOptions = {
  ...
  wireModifiers?: BladeUIModifiers
  wireModel?: Entangle
  colors?: Color[]
}
...
export default (options: InitOptions = { colorNameAsValue: false }): ColorPicker => ({
  ...
  get colors (): Color[] {
    ...
    return window.Alpine.store('bladeui:color-picker')?.colors ?? []
  },
